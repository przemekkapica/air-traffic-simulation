...
public class ScenarioManager {
    ...
    public static void runScenario() {
        ...
        Aircraft aircraft1 = new Aircraft("A_1", 300.0f, 0.0f, airports[0]);
        aircraft1.setSpeed(0.0f);
        aircraft1.setColor(44, 16, 130);

        Aircraft aircraft2 = new Aircraft("A_2", 550.0f, 0.0f, airports[1]);
        aircraft2.setSpeed(0.0f);
        aircraft2.setColor(44, 16, 130);

        Aircraft aircraft3 = new Aircraft("A_3", 320.0f, 0.0f, airports[2]);
        aircraft3.setSpeed(0.0f);
        aircraft3.setColor(44, 16, 130);

        Aircraft aircraft4 = new Aircraft("A_4", 400.0f, 0.0f, airports[3]);
        aircraft4.setSpeed(0.0f);
        aircraft4.setColor(44, 16, 130);

        Aircraft aircraft5 = new Aircraft("A_5", 330.0f, 0.0f, airports[4]);
        aircraft5.setSpeed(0.0f);
        aircraft5.setColor(44, 16, 130);

        Aircraft aircraft6 = new Aircraft("A_6", 320.0f, 0.0f, airports[5]);
        aircraft6.setSpeed(0.0f);
        aircraft6.setColor(44, 16, 130);

        Aircraft aircraft7 = new Aircraft("A_7", 300.0f, 0.0f, airports[6]);
        aircraft7.setSpeed(0.0f);
        aircraft7.setColor(44, 16, 130);

        Aircraft aircraft8 = new Aircraft("A_8", 300.0f, 0.0f, airports[7]);
